/*
 Modified version of OpenCSV by Bytecode Pty Ltd.
...
package com.usda.fmsc.utilities.csv;
...
public class CSVWriter implements Closeable, Flushable {
    ...
    public void writeNext(List<String> nextLine, boolean applyQuotesToAll) {
        ...
        StringBuilder sb = new StringBuilder(nextLine.size() * 2); // This is for the worse case where all elements have to be escaped.
     ...
     * Writes the next line to the file.
     *
     * @param nextLine a string list with each comma-separated element as a separate
     *                 entry.
     */
